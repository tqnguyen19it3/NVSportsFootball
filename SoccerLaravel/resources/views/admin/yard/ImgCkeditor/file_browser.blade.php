...
<html>
<head>
	<title>Duyệt hình ảnh bài viết giới thiệu hệ thống sân</title>
...
<body>
	...
	<div id="fileExplorer">
		...
		<div class="thumbnail">
			<ul class="file-list">
				<li>
					<img src="{{asset('../public/uploads/YardSystemImg/IMGckeditor/'.$file)}}" alt="img" title="{{asset('../public/uploads/YardSystemImg/IMGckeditor/'.$file)}}" width="120" height="130">
					<br>
